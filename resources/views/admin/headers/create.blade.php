    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Your Header</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body">
              <form method="POST" action="{{route('headers.store')}}" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1">
                @csrf
               <div class="card-body">
                ...
                <div class="form-group">
                 ...
                 <input type="mobile" class="form-control" id="mobile1" name="mobile1" placeholder="Please Enter your header Name"/>
                </div>
                <div class="form-group">
                 <label for="exampleInputPassword1">Mobile Number 2 <span class="text-danger">*</span></label>
                 <input type="text" class="form-control" id="mobile2" name="mobile2" placeholder="Please Enter your header Name"/>
                </div>
                <div class="form-group">
                 <label for="exampleInputPassword1">Email<span class="text-danger">*</span></label>
                 <input type="email" class="form-control" id="email" name="email" placeholder="Please Enter your header Name"/>
                </div>
...
@foreach($headers as $header)
    ...
    <tr>
        <td>{{$loop->index+1}}</td>
        <td> {{$header->mobile1}} </td>
        <td>{{$header->mobile2}} </td>
        <td> {{$header->email}}</td>

        <td>
       <input type="checkbox" {{$header->status == 'active' ? 'checked' :''}} id="headerStatus" data-id="{{$header->id}}" data-toggle="toggle"  data-on="Active" data-off="Inactive" data-size="small" data-offstyle="danger">
        </td>
        <td>   <a href="#editModal{{$header->id}}" data-toggle="modal" class="btn btn-warning"  ><i class="flaticon2-edit icon-lg"></i> Edit</a>

             <a href="#deleteModal{{$header->id}}" data-toggle="modal" class="btn btn-danger"><i class="flaticon2-rubbish-bin-delete-button icon-lg"></i> Delete</a>
             ...
             <div class="modal fade" id="deleteModal{{$header->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form action="{{route('headers.delete',$header->id) }}"  method="post">
                                              @csrf
                          ...
                          <div class="modal fade " id="editModal{{$header->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-scrollable" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form class="form-horizontal" action="{{route('headers.update',$header->id) }}"  method="post" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1" >
                                              @csrf
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Mobile 2</label>
                                                       <br>
                                                     <input type="mobile" class="form-control update" id="mobile1" name="mobile1" value="{{$header->mobile1}}">
                                                  </div>
                                                  <br>
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Mobile 2</label>
                                                       <br>
                                                     <input type="mobile" class="form-control update" id="mobile2" name="mobile2" value="{{$header->mobile2}}">
                                                  </div>
                                                  <br>
                                                  ...
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Email</label>
                                                       <br>
                                                     <input type="email" class="form-control update" id="email" name="email" value="{{$header->email}}">
                                                  </div>
                                                  <br>
