    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Your Slider</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body">
              <form method="POST" action="{{route('sliders.store')}}" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1">
                @csrf
               <div class="card-body">


                <div class="form-group">
                 <label for="exampleInputPassword1">Slider Title <span class="text-danger">*</span></label>
                 <input type="text" class="form-control" id="title" name="title" placeholder="Please Enter your slider Name"/>
                </div>
                <div class="form-group">
                 <label for="exampleInputPassword1">Slider Sub_Title <span class="text-danger">*</span></label>
                 <input type="text" class="form-control" id="sub_title" name="sub_title" placeholder="Please Enter your slider Name"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group mb-1">
                 <label for="exampleTextarea">Slider Description <span class="text-danger">*</span></label>
...
@foreach($sliders as $slider)
    ...
    <tr>
        <td>{{$loop->index+1}}</td>
        <td> <?php echo substr($slider->title,0,20); ?> </td>
        <td><?php echo substr($slider->sub_title,0,20); ?> </td>
        <td><img src="{{asset('/sliders/'.$slider->image)}}" style="width: 60px"></td>
        <td>
            <input type="checkbox" {{$slider->status == 'active' ? 'checked' :''}} id="sliderStatus" data-id="{{$slider->id}}" data-toggle="toggle"  data-on="Active" data-off="Inactive" data-size="small" data-offstyle="danger">
        </td>
        <td>   
            <a href="#editModal{{$slider->id}}" data-toggle="modal" class="btn btn-warning"  ><i class="flaticon2-edit icon-lg"></i> Edit
            </a>
             <a href="#deleteModal{{$slider->id}}" data-toggle="modal" class="btn btn-danger"><i class="flaticon2-rubbish-bin-delete-button icon-lg"></i> Delete
            </a>
                          ...
                          <div class="modal fade " id="editModal{{$slider->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-scrollable" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form class="form-horizontal" action="{{route('sliders.update',$slider->id) }}"  method="post" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1" >
                                              @csrf
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Slider Title</label>
                                                       <br>
                                                     <input type="text" class="form-control update" id="title" name="title" value="{{$slider->title}}">
                                                  </div>
                                                  <br>
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Slider Sub_ttle</label>
                                                       <br>
                                                     <input type="text" class="form-control update" id="sub_title" name="sub_title" value="{{$slider->sub_title}}">
                                                  </div>
                                                  <br>
                                                  <div class="col-md-12">
                                                    <br>
                                                    ...
                                                    <div class="col-md-6">
                                                       <label for="oldimage"> old Image</label><br>
                                                         <img src="{{ asset('sliders/'.$slider->image)}}" width="100"><br><br>
                                                 ...
                                                 <input type="file" class="form-control update" name="image" id="image" >
                                                  ...
                                                  <div class="col-md-12">
                                                      <label for="long_description" class=" control-label">Service Description</label>
                                                       <br>
                                                   <textarea id="description" name="description" class="form-control summernote ">{{$slider->description}}</textarea>
                                                  </div>
                                              </div>
