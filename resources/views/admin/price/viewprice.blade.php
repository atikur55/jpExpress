        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">Country Price's List</span>
                    ...
                    <table class="table table-head-custom table-vertical-center" id="travelertable">
                        ...
                        @foreach($price as $prices)
                            <tr>
                                ...
                                <td class="pl-0">
                                    <a href="#"
                                       class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$i}}</a>
                                </td>
                                <td>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control" id="object_type" name="object_type" id="exampleSelectd">
                                                                                       
                                                                                        @if($prices->object_type == 'document1')
                                                                                            <option value="document1" selected>Document 1</option>
                                                                                            <option value="document2">Document 2</option>
                                                                                            <option value="document3">Document 3</option>
                                                                                        @elseif($prices->object_type == 'document2')
                                                                                            <option value="document1">Document 1</option>
                                                                                            <option value="document2" selected>Document 2</option>
                                                                                            <option value="document3">Document 3</option>
                                                                                        @else
                                                                                            <option value="document1">Document 1</option>
                                                                                            <option value="document2">Document 2</option>
                                                                                            <option value="document3" selected>Document 3</option>
                                                                                        @endif
