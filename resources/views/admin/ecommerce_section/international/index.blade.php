              ...
              @endif
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">International Company Name
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="{{route('assign_country.store')}}" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1">
                @csrf
               <div class="card-body">

                <div class="form-group">
                    <label for="exampleInputPassword1">Country Name <span class="text-danger">*</span></label>
                    <select type="text" class="form-control" id="title" name="country_id" placeholder="Please Enter Company Name">
                        <option value="">--select--</option>
                        @foreach ($get_country as $key=> $country)
                ...
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="title" name="company_name" placeholder="Please Enter Company Name"/>
                </div>

                <div class="form-group">
                 <label for="exampleInputPassword1">URL <span class="text-danger">*</span></label>
                 <input type="text" class="form-control" id="sub_title" name="url" placeholder="Please Enter URL"/>
                </div>

                <div class="form-group mb-1">
                    <label for="exampleTextarea">Status <span class="text-danger">*</span></label>
                    <select class="form-control" id="description" name="status" rows="3">
                        <option value="">--Select--</option>
...
@foreach ($datas as $key=> $data)
    <tr>
        <td>{{$i++}}</td>
        <td>
            <img src="{{asset('ecommerce_section/international_ecommerce')}}/{{$data->image}}" width="50px" alt="">
        </td>
        <td>{{$data->connect_country->name}}</td>
        <td>{{$data->company_name}}</td>
        <td>{{$data->url}}</td>
        <td>
        @if($data->status==1)
            <a href="{{url('/international_ecommerce/ChangeStatus/'.$data->id)}}" class="btn btn-sm btn-success"><span class="ti-arrow-up">Active</span></a>
        @else
            <a href="{{url('/international_ecommerce/ChangeStatus/'.$data->id)}}" class="btn btn-sm btn-danger"><span class="ti-arrow-down">Inactive</span></a>
        @endif

            <!-- <input type="checkbox" {{$data->status == 1 ? 'checked' :''}} id="sliderStatus" data-id="{{$data->id}}" data-toggle="toggle"  data-on="Active" data-off="Inactive" data-size="small" data-offstyle="danger"> -->
        </td>
        <td>
            <a href="#editModal{{$data->id}}" data-toggle="modal" class="btn btn-warning"  ><i class="flaticon2-edit icon-lg"></i> Edit
            </a>
             <a href="#deleteModal{{$data->id}}" data-toggle="modal" class="btn btn-danger"><i class="flaticon2-rubbish-bin-delete-button icon-lg"></i> Delete
            </a>
             ...
             <div class="modal fade" id="deleteModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form action="{{route('assign_country.delete',$data->id)}}"  method="post">
                                              @csrf
                          ...
                          <div class="modal fade " id="editModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-scrollable" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form class="form-horizontal" action="{{route('assign_country.update',$data->id)}}"  method="post" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1" >
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <label for="name" class=" control-label">Country Name</label>
                                                     <br>
                                                   <select type="text" class="form-control update" id="title" name="country_id">
                                                      <option value="">--Select--</option>
                                                       @foreach ($get_country as $key=> $country)
                                                  ...
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Company Name</label>
                                                       <br>
                                                     <input type="text" class="form-control update" id="title" name="company_name" value="{{$data->company_name}}">
                                                  </div>
                                                  <br>
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">URL</label>
                                                       <br>
                                                     <input type="text" class="form-control update" id="sub_title" name="url" value="{{$data->url}}">
                                                  </div>

                                                  <div class="col-md-12">
                                                    <label for="name" class=" control-label">Status</label>
                                                     <br>
                                                   <select type="text" class="form-control update" id="sub_title" name="status" value="">
                                                       <option value="">--Select--</option>
                                                  ...
                                                  <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                       <label for="oldimage"> Old Logo</label><br>
                                                         <img src="{{asset('ecommerce_section/international_ecommerce')}}/{{$data->image}}" width="100"><br><br>
