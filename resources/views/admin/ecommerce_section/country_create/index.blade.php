              ...
              @endif
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Country Name
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Country Name</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body">
              <form method="POST" action="{{route('country_create.store')}}" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1">
                @csrf
               <div class="card-body">
                ...
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="title" name="name" placeholder="Please Enter Country Name"/>
                </div>
...
@foreach ($datas as $key=> $data)
    <tr>
        ...
        <td>
        @if($data->status==1)
            <a href="{{url('/country_create/ChangeStatus/'.$data->id)}}" class="btn btn-sm btn-success"><span class="ti-arrow-up">Active</span></a>
        @else
            <a href="{{url('/country_create/ChangeStatus/'.$data->id)}}" class="btn btn-sm btn-danger"><span class="ti-arrow-down">Inactive</span></a>
        @endif
             ...
             <div class="modal fade" id="deleteModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form action="{{route('country.delete',$data->id)}}"  method="post">
                                              @csrf
                          ...
                          <div class="modal fade " id="editModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-scrollable" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form class="form-horizontal" action="{{route('country_create.update',$data->id)}}"  method="post" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1" >
                                              @csrf
                                            {{method_field('PUT')}}
                                              <div class="form-group">
