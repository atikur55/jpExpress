              ...
              @endif
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Bangladesh E-Commerce
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="{{route('bdecommerce.store')}}" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1">
                @csrf
               <div class="card-body">
                ...
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="title" name="name" placeholder="Please Enter Company Name"/>
                </div>
...
@foreach ($datas as $key=> $data)
    <tr>
        <td>{{$i++}}</td>
        <td>
            <img src="{{asset('ecommerce_section/bd_ecommerce')}}/{{$data->image}}" width="50px" alt="">
        </td>
        <td>{{$data->name}}</td>
        <td>{{$data->url}}</td>
        <td>
        @if($data->status==1)
            <a href="{{url('/bd_ecommerce/ChangeStatus/'.$data->id)}}" class="btn btn-sm btn-success"><span class="ti-arrow-up">Active</span></a>
        @else
            <a href="{{url('/bd_ecommerce/ChangeStatus/'.$data->id)}}" class="btn btn-sm btn-danger"><span class="ti-arrow-down">Inactive</span></a>
        @endif
        </td>
             ...
             <div class="modal fade" id="deleteModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form action="{{route('bdecommerce.delete',$data->id)}}"  method="post">
                                              @csrf
                          ...
                          <div class="modal fade " id="editModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-scrollable" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form class="form-horizontal" action="{{route('bdecommerce.update',$data->id)}}"  method="post" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1" >
                                              @csrf
                                            {{method_field('PUT')}}
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Company Name</label>
                                                       <br>
                                                     <input type="text" class="form-control update" id="title" name="name" value="{{$data->name}}">
                                                  </div>
                                                  <br>
                                                  <div class="col-md-12">
                                                  ...
                                                  <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                       <label for="oldimage"> Old Logo</label><br>
                                                         <img src="{{asset('ecommerce_section/bd_ecommerce')}}/{{$data->image}}" width="100"><br><br>
