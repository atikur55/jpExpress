    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="{{route('services.store')}}" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1">
                @csrf
               <div class="card-body">
                ...
                <div class="form-group">
                 <label for="exampleInputPassword1">Service Name <span class="text-danger">*</span></label>
                 <input type="text" class="form-control" id="name" name="name" placeholder="Please Enter your service Name"/>
                </div>

                <div class="form-group mb-1">
                 <label for="exampleTextarea">Service Description <span class="text-danger">*</span></label>
...
@foreach($services as $service)
    ...
    <tr>
        <td>{{$loop->index+1}}</td>
        <td> {{$service->name}}</td>
        <td>  <img src="{{asset('/images/'.$service->image)}}" style="width: 60px"></td>

        <td>
       <input type="checkbox" {{$service->status == 'active' ? 'checked' :''}} id="serviceStatus" data-id="{{$service->id}}" data-toggle="toggle"  data-on="Active" data-off="Inactive" data-size="small" data-offstyle="danger">
        </td>
        <td>   <a href="#editModal{{$service->id}}" data-toggle="modal" class="btn btn-warning"  ><i class="flaticon2-edit icon-lg"></i> Edit</a>

             <a href="#deleteModal{{$service->id}}" data-toggle="modal" class="btn btn-danger"><i class="flaticon2-rubbish-bin-delete-button icon-lg"></i> Delete</a>

             <div class="modal fade" id="deleteModal{{$service->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                          ...
                          <div class="modal fade " id="editModal{{$service->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-scrollable" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header state modal-primary">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Service Name</label>
                                                       <br>
                                                     <input type="text" class="form-control update" id="name" name="name" value="{{$service->name}}">
                                                  </div>
                                                  <br>
                                                  <div class="col-md-12">
                                                    <br>
                                                    ...
                                                    <div class="col-md-6">
                                                       <label for="oldimage"> old Image</label><br>
                                                         <img src="{{ asset('images/'.$service->image)}}" width="100"><br><br>
                                                 ...
                                                 <input type="file" class="form-control update" name="image" id="image" >
                                                  ...
                                                  <div class="col-md-12">
                                                      <label for="long_description" class=" control-label">Service Description</label>
                                                       <br>
                                                   <textarea id="description" name="description" class="form-control summernote ">{{$service->description}}</textarea>
                                                  </div>
                                              </div>
