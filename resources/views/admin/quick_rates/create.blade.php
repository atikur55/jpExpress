    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="{{route('quick_rates.store')}}" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1">
                @csrf
               <div class="card-body">
...
<tbody>
@foreach($quickRateImages as $quick_rate)


    <tr>
        <td>{{$loop->index+1}}</td>

        <td>  <img src="{{asset('/quickRateImages/'.$quick_rate->image)}}" style="width: 60px"></td>

        <td>
       <input type="checkbox" {{$quick_rate->status == 'active' ? 'checked' :''}} id="QuickRateStatus" data-id="{{$quick_rate->id}}" data-toggle="toggle"  data-on="Active" data-off="Inactive" data-size="small" data-offstyle="danger">
        </td>
        <td>   <a href="#editModal{{$quick_rate->id}}" data-toggle="modal" class="btn btn-warning"  ><i class="flaticon2-edit icon-lg"></i> Edit</a>

             <a href="#deleteModal{{$quick_rate->id}}" data-toggle="modal" class="btn btn-danger"><i class="flaticon2-rubbish-bin-delete-button icon-lg"></i> Delete</a>

             <div class="modal fade" id="deleteModal{{$quick_rate->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form action="{{route('quick_rates.delete',$quick_rate->id) }}"  method="post">
                                              @csrf
                          ...
                          <div class="modal fade " id="editModal{{$quick_rate->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-scrollable" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header state modal-primary">
                                      ...
                                      <div class="modal-body">
                                          <form class="form-horizontal" action="{{route('quick_rates.update',$quick_rate->id) }}"  method="post" enctype="multipart/form-data"  >
                                              @csrf
                                                  ...
                                                  <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                       <label for="oldimage"> old Image</label><br>
                                                         <img src="{{ asset('quickRateImages/'.$quick_rate->image)}}" width="100"><br><br>
