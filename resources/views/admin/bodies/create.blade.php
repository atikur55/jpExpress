    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Your Body Part</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body">
              <form method="POST" action="{{route('bodies.store')}}" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1">
                @csrf
               <div class="card-body">


                <div class="form-group">
                 <label for="exampleInputPassword1">Body Title <span class="text-danger">*</span></label>
                 <input type="text" class="form-control" id="title" name="title" placeholder="Please Enter your body Name"/>
                </div>
                <div class="form-group">
                 <label for="exampleInputPassword1">Body Sub_Title <span class="text-danger">*</span></label>
                 <input type="text" class="form-control" id="sub_title" name="sub_title" placeholder="Please Enter your body Name"/>
                </div>
                <div class="form-group">
...
@foreach($bodies as $body)
    ...
    <tr>
        <td>{{$loop->index+1}}</td>
        <td> <?php echo substr($body->title,0,50); ?> </td>
        <td><?php echo substr($body->sub_title,0,20); ?> </td>
        <td>  <img src="{{asset('/bodies/'.$body->image)}}" style="width: 60px"></td>

        <td>
       <input type="checkbox" {{$body->status == 'active' ? 'checked' :''}} id="bodyStatus" data-id="{{$body->id}}" data-toggle="toggle"  data-on="Active" data-off="Inactive" data-size="small" data-offstyle="danger">
        </td>
        <td>   <a href="#editModal{{$body->id}}" data-toggle="modal" class="btn btn-warning"  ><i class="flaticon2-edit icon-lg"></i> Edit</a>

             <a href="#deleteModal{{$body->id}}" data-toggle="modal" class="btn btn-danger"><i class="flaticon2-rubbish-bin-delete-button icon-lg"></i> Delete</a>

             <div class="modal fade" id="deleteModal{{$body->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form action="{{route('bodies.delete',$body->id) }}"  method="post">
                                              @csrf
                          ...
                          <div class="modal fade " id="editModal{{$body->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-scrollable" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header state modal-primary">
                                      ...
                                      <div class="modal-body">
                                          <form class="form-horizontal" action="{{route('bodies.update',$body->id) }}"  method="post" enctype="multipart/form-data" id="kt_form_1" name="kt_form_1" >
                                              @csrf
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Body Title</label>
                                                       <br>
                                                     <input type="text" class="form-control update" id="title" name="title" value="{{$body->title}}">
                                                  </div>
                                                  <br>
                                                  <div class="col-md-12">
                                                      <label for="name" class=" control-label">Body Sub_ttle</label>
                                                       <br>
                                                     <input type="text" class="form-control update" id="sub_title" name="sub_title" value="{{$body->sub_title}}">
                                                  </div>
                                                  <br>
                                                  <div class="col-md-12">
                                                    <br>
                                                    ...
                                                    <div class="col-md-6">
                                                       <label for="oldimage"> old Image</label><br>
                                                         <img src="{{ asset('bodies/'.$body->image)}}" width="100"><br><br>
