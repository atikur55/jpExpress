...
<head><base href="">
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{asset('admintemplate/assets/media/logos/logo-light.png')}}" />
            ...
            <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="http:essential-infotech.com" target="_blank" class="text-dark-75 text-hover-primary">Essential-Infotech</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Nav-->
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url('{{asset('uploads/user/')}}/{{Auth::user()->image}}')"></div>
            ...
            <div class="navi navi-spacer-x-0 p-0">
                ...
                <!--end:Item-->
                <!--begin::Item-->
                <a href="{{url('edit_profile')}}" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-md svg-icon-success">
    ...
    <div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
        ...
        <div class="offcanvas-content px-10">
            <div class="tab-content">
                ...
                @php
                    // $notifications = App\OnlineBook::where('status',0)->get(); 
                    $notifications = App\OnlineBook::orderBy('id','desc')->get(); 
                @endphp
                    <div class="navi navi-icon-circle navi-spacer-x-0">
                        <!--begin::Item-->
                        @foreach($notifications as $notification)
                        <a href="{{url('view-order')}}/{{$notification->id}}" class="navi-item">
                            <div class="navi-link rounded" style="{{$notification->notification == 0 ? 'background: antiquewhite;margin-bottom: 2px;':'background: white;margin-bottom: 2px;'}}">
                                ...
                                <div class="navi-text">
                                    <div class="font-weight-bold font-size-lg">{{$notification->track_id}}</div>
