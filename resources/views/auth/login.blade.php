                ...
                <div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
                    ...
                    <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                        ...
                        <a href="{{url('/')}}" class="text-center pt-2">
                            <img src="{{asset('admintemplate/assets/media/logos/jpex.png')}}" class="max-h-75px" alt="" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Aside body-->
                            ...
                            <div class="login-form login-signin py-11">
                                ...
                                @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Enter Your Email">
                                ...
                                @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password" type="password" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Enter Your Password">
