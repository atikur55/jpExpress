                            ...
                            <div class="d-flex align-items-center">
                                <div
                                    ...
                                    <div class="symbol-label"
                                         style="background-image:url('{{asset('uploads/user/')}}/{{Auth::user()->image}}')"></div>
                        ...
                        <div class="card-header py-3">
                            ...
                            @foreach($users as $user)
                                @if(Auth::user()->name == $user->name)
                                    {{-- <form class="form" action="/editinfo/{{$user->id}}" method="POST" enctype="multipart/form-data"> --}}
                                    <form class="form" action="{{ url('update_profile') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{-- {{ csrf_field() }}
                                        {{ method_field('PUT') }} --}}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="image-input image-input-outline" id="kt_profile_avatar"
                                         style="background-image: url('{{asset('uploads/user/')}}/{{Auth::user()->image}}')">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    ...
                                    <input class="form-control form-control-lg form-control-solid" name="id"type="hidden" value="{{$user->id}}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid" name="email" value="{{$user->email}}"/>
                                    </div>
                                </div>
                            </div>
