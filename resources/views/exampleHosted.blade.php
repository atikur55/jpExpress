        ...
        <p class="lead">Below is an example form built entirely with Bootstrap’s form controls. We have provided this sample form for understanding Hosted Checkout Payment with SSLCommerz.</p>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="hidden" name="track_id" value="{{$track_number}}">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" class="form-control" id="mobile" placeholder="Mobile" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="zap" id="zip" placeholder="" required>
                        <div class="invalid-feedback">
                            Zip code required.
                        </div>
                    </div>
                ...
                <div class="custom-control custom-checkbox">
                    ...
                    <span>Amount</span>&nbsp;&nbsp;
                    <input type="text" name="amount" id="total_amount" placeholder="1200" required/><br>
